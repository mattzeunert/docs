...
This guide explains how to set up continuous monitoring for your production site, as well as automatic testing of each deployment.
...
You need to select the account or team your ZEIT project belongs to, and will then be redirected to the DebugBear website.
...
Select which of your ZEIT projects you'd like to monitor and then click **Set up**.

DebugBear will automatically start monitoring the project homepage and up to 3 other pages on your site.
