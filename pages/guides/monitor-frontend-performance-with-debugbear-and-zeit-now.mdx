...
export const meta = {
  ...
  lastEdited: '2020-03-31T15:53:22.000Z'
}
...
With your project set up with ZEIT, install the [DebugBear integration](https://zeit.co/integrations/debugbear) from the ZEIT Integrations Marketplace to add it to your account.

<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/debugbear-integration.png`}
  width={1206 / 2}
  height={416 / 2}
  oversize
  shadow
...
Select the account or team you imported your project for to install the integration. Once selected, you will then be redirected to DebugBear.

<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/select-zeit-team.png`}
  width={1300 / 2}
  height={1226 / 2}
  oversize
  shadow
/>
<Caption>Grant DebugBear access to the account that your project belongs to.</Caption>
...
<Image
  ...
  shadow
/>
<Caption>Sign up to DebugBear with your ZEIT account, or use an existing DebugBear account.</Caption>
...
<Image
  src={`${
    process.env.ASSETS
  }/guides/monitor-frontend-performance-with-debugbear-and-zeit-now/select-zeit-project.png`}
  width={816 / 2}
  height={406 / 2}
  oversize
  shadow
...
DebugBear will automatically start monitoring your projects homepage and up to 3 other pages on your site.
...
- Or, on GitHub (described in [Step 4](#step-4:-report-build-statuses-to-github))
